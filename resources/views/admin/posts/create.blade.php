        ...
        <form action="{{ route('admin.posts.store') }}" method="post" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-3">
                ...
                <div class="form-check mb-3">
                    <input @if (in_array($tag->id, old('tags', []))) checked @endif name="tags[]" type="checkbox" class="form-check-input @error("tags.$loop->index") is-invalid @enderror" value="{{$tag->id}}" id="tag-{{$tag->id}}">
